...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_data, values=class_proportions.values,
...
def get_scatter_plot(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(data, x='Payload Mass (kg)', y='class', color='Booster Version Category', title='Correlation between Payload and Success')
        return fig
    else:
        filtered_data = data[data['Launch Site'] == entered_site]
        fig = px.scatter(filtered_data, x='Payload Mass (kg)', y='class', color='Booster Version Category', title='Correlation between Payload and Success')
        return fig
